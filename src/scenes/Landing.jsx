            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                >
                    ...
                    <p className="mt-10 mb-7 text-sm text-center md:text-start">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat accusantium quidem voluptatem ducimus dolorum libero sint voluptate illum enim harum laboriosam aperiam, necessitatibus ratione debitis sunt nulla laborum dicta. Officiis!
                    </p>
                </motion.div>
